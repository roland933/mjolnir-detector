...
import { ThorImage } from "../dashboard/thorImage";
import { EndingChoice, EndingState } from "@/app/types/ending.type";
...
export function EndingModal({ open, onClose, onChoice }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[3000] flex items-center justify-center bg-neutral-950/90 p-6 backdrop-blur-md">
      ...
      <div className="relative w-full max-w-5xl">
        ...
        <NorsePanel className="overflow-hidden">
          <button
            type="button"
            onClick={onClose}
            className="absolute right-5 top-5 z-20 text-neutral-500 transition hover:text-white"
          >
            <X className="h-5 w-5" />
          </button>
          ...
          <div className="grid min-h-[600px] lg:grid-cols-2">
            ...
            <div className="relative min-h-[400px] overflow-hidden">
              <ThorImage endingState={endingState} />
            </div>
